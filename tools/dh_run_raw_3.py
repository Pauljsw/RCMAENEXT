...
config_path = "/home/duho/VoxelNeXt/models/0528_real_synth/voxelnext_isarc_3chan_4class.yaml"
...
model_path = "/home/duho/VoxelNeXt/models/0528_real_synth/checkpoint_epoch_50.pth"
#model_path = "/home/duho/VoxelNeXt/models/onlysynthetic_0522/checkpoint_epoch_50.pth"
...
label_colors = [
    ...
    [0.0, 1.0, 0.0],  # Green  #2 dozer   #2 excavator
    [0.0, 0.0, 1.0],  # Blue   #3 excavator #3 grader
    [0.0, 1.0, 1.0],  # Cyan   #4 grader  #4 roller
...
rospy.Timer(rospy.Duration(0.1), publish_cb)  # 10Hz 타이머
rospy.spin()  # while 루프 대신 spin으로 안정적 유지
