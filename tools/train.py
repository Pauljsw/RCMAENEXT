...
def main():
    ...
    for name, param in model.named_parameters():
        if name.startswith("backbone_3d.conv1") or name.startswith("backbone_3d.conv2") or name.startswith("backbone_3d.conv3") or name.startswith("backbone_3d.conv4") or name.startswith("backbone_3d.conv5") or name.startswith("backbone_3d.conv6"):
            param.requires_grad = False
            print(f"Freezing: {name}")  # Freeze된 Layer 출력
    '''
    ...
    train_model(
        ...
        optimizer,
        train_loader,
        val_loader,  # Add validation loader here
